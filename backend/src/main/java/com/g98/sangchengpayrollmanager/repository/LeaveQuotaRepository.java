...
public interface LeaveQuotaRepository extends JpaRepository<LeaveQuota, Long> {
    ...
    List<LeaveQuota> findByEmployeeCodeAndYear(String employeeCode, Integer year);

    boolean existsByEmployeeCodeAndYear(String employeeCode, Integer year);

    boolean existsByEmployeeCodeAndLeaveTypeCodeAndYear(String employeeCode,

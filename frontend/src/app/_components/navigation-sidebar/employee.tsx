...
import { ChevronLeft, ChevronRight, FileUser, HandCoins, House } from "lucide-react";
...
export default function NavigationSidebar({select}: { select: number }) {
    ...
    const menuItems = [
        { id: 1, href: "/employee", icon: House, label: "Trang chủ" },
        { id: 3, href: "/employee/payroll", icon: HandCoins, label: "Lương" },
        { id: 4, href: "/employee/request", icon: FileUser, label: "Yêu cầu" },
    ];
